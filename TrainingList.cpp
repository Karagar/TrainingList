...
// TrainingList.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTrainingListApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CTrainingListApp

CTrainingListApp::CTrainingListApp()
{
...
// Единственный объект CTrainingListApp

CTrainingListApp theApp;


// Инициализация CTrainingListApp

BOOL CTrainingListApp::InitInstance()
{
